...
<head>
	...
	<script>
        ...
        function stupidValidate()
        {
            var user = document.getElementById('unames').value;
            var pword = document.getElementById('pword').value;
            
            if(user == "user1234" && pword== "1234")
            {
...
<body>
	...
	<div class="content">
		...
		<div class="dropdown">
		<button class="regbutt" type="button" >Register<span class="caret"></span> </button>
		
		
		<input type="Submit" class="loginbutt" name="buttonsubmit" value="Login" onclick= "stupidValidate()"><br>
                </form>
		</div>
	</div>
</body>
